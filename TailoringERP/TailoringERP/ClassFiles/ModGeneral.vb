...
#Region "Function"
    ...
    'Public Function Insert_TaskType(ByVal taskType As String, ByVal taskDetail As String, ByVal taskColor As String) As Boolean
    '    Try
    '        sql_query = "INSERT INTO TaskTypeMaster (TaskType, TaskDetail, TaskDocId, SOPId, TaskColor) " &
    '                "VALUES (@TaskType, @TaskDetail, 0, 0, @TaskColor)"

    '        obj.Prepare("")

    '        obj.AddCmdParameter("@TaskType", Dtype.nvarchar, taskType, ParaDirection.Input, True)
    '        obj.AddCmdParameter("@TaskDetail", Dtype.nvarchar, taskDetail, ParaDirection.Input, True)
    '        obj.AddCmdParameter("@TaskColor", Dtype.nvarchar, taskColor, ParaDirection.Input, True)

    '        obj.ScalarExecute(sql_query)
    '        Return True
